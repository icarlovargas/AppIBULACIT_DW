    ...
    public class UsuarioController : ApiController
    {
        ...
        public IHttpActionResult GetId(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT Codigo, Identificacion, Nombre, UserName, Password,
        ...
        public IHttpActionResult Actualizar(Usuario usuario)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"UPDATE Usuario SET Identificacion = @Identificacion,
                                                                Nombre = @Nombre,
                                                                UserName = @UserName,
                                                                Password = @Password,
                                                                Email = @Email,
        ...
        public IHttpActionResult Eliminar(int id)
        {
            ...
            try
            {
                using (SqlConnection sqlConnection = new
                    SqlConnection(ConfigurationManager.ConnectionStrings["INTERNET_BANKING"].ConnectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(@"DELETE Usuario WHERE Codigo = @Codigo ", sqlConnection);
