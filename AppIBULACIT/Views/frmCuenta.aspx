...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    </script> <!--Paso 7 Agregamos el script -->

    <h1><asp:Label Text="Informacion de Cuentas" runat="server"></asp:Label></h1> <!--Paso 1 cambiamos el titulo--> 
    <br />
    <input id="myInput" Placeholder="Buscar" class="form-control" type="text" /> <!-- Paso 8 -->
    <br />
    ...
    </asp:GridView> <!--Paso 2 agregamos el gridview y modificamos las columnas-->
    <br />
    <asp:LinkButton type="button" CssClass="btn btn-success" OnClick="btnNuevo_Click" ID="btnNuevo"  
        runat="server" Text="<span aria-hidden='true' class='glyphicon glyphicon-floppy-disk'></span> Nuevo" /> <!-- Paso 3 Agregamos el LinkButton  /// Paso 9 creamos el evento onclick -->
    <br />
    <asp:Label ID="lblStatus" ForeColor="Maroon" runat="server" Visible="false" /> <!-- Paso 4 Agregamos el lblStatus -->
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              <tr>
                  ...
                  <td><asp:TextBox ID="txtCodigoMant" Enabled="false" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrCodigoUsuarioMan" Text="Codigo Usuario" runat="server" /></td>
                  <td><asp:TextBox ID="txtCodigoUsuarioMan" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td><asp:TextBox ID="txtIBAN" runat="server"  CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrCodigoMonedaMan" Text="Codigo de Moneda" runat="server" /></td>
                  <td><asp:TextBox ID="txtCodigoMonedaMan" runat="server"  CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrSaldo" Text="Saldo" runat="server" /></td>
                  <td><asp:TextBox ID="txtSaldo" runat="server"  CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal Text="Estado" runat="server" /></td>
                  <td> <asp:DropDownList ID="ddlEstadoMant" Enabled="true" CssClass="form-control" runat="server">
