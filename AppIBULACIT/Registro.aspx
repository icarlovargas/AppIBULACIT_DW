<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="AppIBULACIT.Registro" %>
        ...
        <form class="modal-content animate" runat="server">
            ...
            <div class="container">
                ...
                <asp:RequiredFieldValidator ID="rfvNombre" runat="server"
                    ErrorMessage="El nombre es requerido" ControlToValidate="txtNombre"></asp:RequiredFieldValidator>
                <asp:TextBox ID="txtEmail" Placeholder="Ingrese su correo electronico" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvEmail" runat="server"
                    ErrorMessage="El correo electronico es requerido" ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
                <asp:TextBox ID="txtFechaNacimiento" Placeholder="Ingrese su fecha de nacimiento" runat="server"></asp:TextBox>
                <asp:Button ID="btnFechaNac" OnClick="btnFechaNac_Click" runat="server" Text="Seleccionar fecha" />
